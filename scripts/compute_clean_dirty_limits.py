...
import pandas as pd
import numpy as np
from simulation.quantities import B, J  # Assuming B and J functions are imported from quantities
...
for folder in subfolders:
    ...
    lambda_eff_path_corr = os.path.join(folder, 'data', 'penetration_depth_corrected.csv')
    ...
    if 'penetration_depth_corrected' not in df_lambda_corr.columns:
        print(f"Column 'penetration_depth_corrected' not found in {lambda_eff_path_corr}")
        continue
    ...
    current_density_path_corr = os.path.join(folder, 'data', 'current_density_corrected.csv')
    ...
    screening_profile_path_corr = os.path.join(folder, 'data', 'screening_profile_corrected.csv')
